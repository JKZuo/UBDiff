import argparse
def parse_args():
    parser = argparse.ArgumentParser(description="Bridge-based Diffusion Model for POI Recommendation")
    ...
    parser.add_argument('--dataset', type=str, default='LA', help="available datasets: ['IST', 'TKY', 'NYC', 'LA']") 
